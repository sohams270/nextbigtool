...
export const metadata: Metadata = {
  title: "NextBigTool vs AppSumo | NextBigTool",
  description: "Compare NextBigTool vs AppSumo. See which platform is better for indie founders and product discovery.",
};
