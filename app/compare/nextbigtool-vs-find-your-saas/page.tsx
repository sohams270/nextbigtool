...
export const metadata: Metadata = {
  title: "NextBigTool vs Find Your SaaS | NextBigTool",
  description: "Compare NextBigTool vs Find Your SaaS. See which platform is better for indie founders and product discovery.",
};
