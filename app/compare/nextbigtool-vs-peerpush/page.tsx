...
export const metadata: Metadata = {
  title: "NextBigTool vs PeerPush | NextBigTool",
  description: "Compare NextBigTool vs PeerPush. See which platform is better for indie founders and product discovery.",
};
