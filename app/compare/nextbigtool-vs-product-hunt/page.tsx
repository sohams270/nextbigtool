...
export const metadata: Metadata = {
  title: "NextBigTool vs Product Hunt | NextBigTool",
  description: "Compare NextBigTool vs Product Hunt. See which platform is better for indie founders and product discovery.",
};
