...
export const metadata: Metadata = {
  title: "NextBigTool vs ToolFinder | NextBigTool",
  description: "Compare NextBigTool vs ToolFinder. See which platform is better for indie founders and product discovery.",
};
