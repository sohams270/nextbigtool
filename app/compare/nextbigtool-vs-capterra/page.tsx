...
export const metadata: Metadata = {
  title: "NextBigTool vs Capterra | NextBigTool",
  description: "Compare NextBigTool vs Capterra. See which platform is better for indie founders and product discovery.",
};
