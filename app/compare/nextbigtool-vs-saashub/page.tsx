...
export const metadata: Metadata = {
  title: "NextBigTool vs SaaSHub | NextBigTool",
  description: "Compare NextBigTool vs SaaSHub. See which platform is better for indie founders and product discovery.",
};
