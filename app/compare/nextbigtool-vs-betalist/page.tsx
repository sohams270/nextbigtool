...
export const metadata: Metadata = {
  title: "NextBigTool vs BetaList | NextBigTool",
  description: "Compare NextBigTool vs BetaList. See which platform is better for indie founders and product discovery.",
};
