...
export const metadata: Metadata = {
  title: "NextBigTool vs AlternativeTo | NextBigTool",
  description: "Compare NextBigTool vs AlternativeTo. See which platform is better for indie founders and product discovery.",
};
