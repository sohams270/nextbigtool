...
const NAV = [
  ...
  { id: "interested", label: "Founder's CRM",  href: "/dashboard/founder-crm",          icon: UsersIcon,    prime: true, gate: "crm"  as GatedFeature },
  { id: "blog",       label: "Press Release",  href: "/dashboard/press-release-request", icon: FileTextIcon, prime: true, gate: "blog" as GatedFeature },
