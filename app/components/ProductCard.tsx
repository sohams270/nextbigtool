    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 3 }}>
          <span className="product-name" style={{ fontSize: featured ? 14 : 13, fontWeight: 700, color: "var(--ink)", transition: "color 0.15s" }}>{name}</span>
        ...
        <div style={{ fontSize: 11, color: "var(--ink-muted)", fontWeight: 400, marginBottom: 6, lineHeight: 1.4 }}>
          {tagline}
        </div>
        {tags.length > 0 && (
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <svg width={10} height={10} viewBox="0 0 24 24" fill="none" stroke="var(--ink-faint)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        >
          <svg width={featured ? 12 : 10} height={featured ? 12 : 10} viewBox="0 0 24 24" fill="none" stroke="var(--ink-muted)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
          </svg>
          <span style={{ fontSize: featured ? 12 : 10, fontWeight: 600, color: "var(--ink-muted)" }}>{comments}</span>
        </div>
